...
const AddEvent = () => {
    ...
    const handleFormSubmit = (e) => {
        e.preventDefault(); //Evita que la página se recargue al pulsar Enter o el botón (se me rompía).
        saveEvent();
    };
    ...
    return (
        <form className={styles.page} onSubmit={handleFormSubmit}>
            ...
            <div className={styles.acceptCancel}>
                <button type="button" className={styles.cancelBtn} onClick={changeDecisionAddEvent}>
                    Cancelar
                </button>
