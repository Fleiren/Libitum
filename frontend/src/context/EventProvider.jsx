    ...
    const saveEvent = async() => {
        try {
            if(event) {
                ...
                if(data?.event) {
                    // Añadimos el evento a la lista local.
                    const newEvent = { ...data.event, liked: false };
                    setEvents([...events, newEvent]);
                    
                    // Limpiamos el formulario devolviéndolo a su estado inicial.
                    setEvent(initialEvent);
                    
                    // Cerramos el panel de "Añadir Evento".
                    setDecisionAddEvent(false);
                    
                    // Avisamos al usuario.
                    showMessageWithTime("¡Evento creado correctamente!", "success");
